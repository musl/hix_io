 ...
 * Mon, 27 Apr 2015 02:22:31 GMT
 * Licensed MIT

 * Includes: can/component/component,can/construct/construct,can/map/map,can/list/list,can/compute/compute,can/model/model,can/view/view,can/control/control,can/route/route,can/control/route/route,can/view/mustache/mustache,can/view/stache/stache
 * Download from: http://bitbuilder.herokuapp.com/can.custom.js?configuration=jquery&minify=true&plugins=can%2Fcomponent%2Fcomponent&plugins=can%2Fconstruct%2Fconstruct&plugins=can%2Fmap%2Fmap&plugins=can%2Flist%2Flist&plugins=can%2Fcompute%2Fcompute&plugins=can%2Fmodel%2Fmodel&plugins=can%2Fview%2Fview&plugins=can%2Fcontrol%2Fcontrol&plugins=can%2Froute%2Froute&plugins=can%2Fcontrol%2Froute%2Froute&plugins=can%2Fview%2Fmustache%2Fmustache&plugins=can%2Fview%2Fstache%2Fstache
 */
/*[global-shim-start]*/
...
define("can/view/stache/stache",["can/util/util","can/view/parser/parser","can/view/target/target","can/view/stache/html_section","can/view/stache/text_section","can/view/stache/mustache_core","can/view/stache/mustache_helpers","can/view/stache/intermediate_and_imports","can/view/callbacks/callbacks","can/view/bindings/bindings"],function(e,t,n,a,i,c,r,s,o){function d(n){"string"==typeof n&&(n=c.cleanLineEndings(n));var r=new a,s={node:null,attr:null,sectionElementStack:[],text:!1,namespaceStack:[]},d=function(e,t,n){if(">"===t)e.add(c.makeLiveBindingPartialRenderer(n,s));else if("/"===t)e.endSection(),e instanceof a&&s.sectionElementStack.pop();else if("else"===t)e.inverse();else{var i=e instanceof a?c.makeLiveBindingBranchRenderer:c.makeStringBranchRenderer;"{"===t||"&"===t?e.add(i(null,n,u())):"#"===t||"^"===t?(e.startSection(i(t,n,u())),e instanceof a&&s.sectionElementStack.push("section")):e.add(i(null,n,u({text:!0})))}},u=function(t){var n={tag:s.node&&s.node.tag,attr:s.attr&&s.attr.name,directlyNested:s.sectionElementStack.length?"section"===s.sectionElementStack[s.sectionElementStack.length-1]:!0};return t?e.simpleExtend(n,t):n},p=function(e,t){e.attributes||(e.attributes=[]),e.attributes.push(t)};return t(n,{start:function(t,n){var a=l[t];a&&!n&&s.namespaceStack.push(a),s.node={tag:t,children:[],namespace:a||e.last(s.namespaceStack)}},end:function(e,t){var n=o.tag(e);t?(r.add(s.node),n&&p(s.node,function(t,n,a){o.tagHandler(this,e,{scope:t,options:n,subtemplate:null,templateType:"stache",parentNodeList:a})})):(r.push(s.node),s.sectionElementStack.push("element"),n&&r.startSubSection()),s.node=null},close:function(e){var t=l[e];t&&s.namespaceStack.pop();var n,a=o.tag(e);a&&(n=r.endSubSectionAndReturnRenderer());var i=r.pop();a&&p(i,function(t,a,i){o.tagHandler(this,e,{scope:t,options:a,subtemplate:n,templateType:"stache",parentNodeList:i})}),s.sectionElementStack.pop()},attrStart:function(e){s.node.section?s.node.section.add(e+'="'):s.attr={name:e,value:""}},attrEnd:function(e){if(s.node.section)s.node.section.add('" ');else{s.node.attrs||(s.node.attrs={}),s.node.attrs[s.attr.name]=s.attr.section?s.attr.section.compile(u()):s.attr.value;var t=o.attr(e);t&&(s.node.attributes||(s.node.attributes=[]),s.node.attributes.push(function(n,a){t(this,{attributeName:e,scope:n,options:a})})),s.attr=null}},attrValue:function(e){var t=s.node.section||s.attr.section;t?t.add(e):s.attr.value+=e},chars:function(e){r.add(e)},special:function(e){var t=c.splitModeFromExpression(e,s),n=t.mode,a=t.expression;if("else"===a)return void(s.attr&&s.attr.section?s.attr.section:r).inverse();if("!"!==n)if(s.node&&s.node.section)d(s.node.section,n,a),0===s.node.section.subSectionDepth()&&(s.node.attributes.push(s.node.section.compile(u())),delete s.node.section);else if(s.attr)s.attr.section||(s.attr.section=new i,s.attr.value&&s.attr.section.add(s.attr.value)),d(s.attr.section,n,a);else if(s.node)if(s.node.attributes||(s.node.attributes=[]),n){if("#"!==n&&"^"!==n)throw n+" is currently not supported within a tag.";s.node.section||(s.node.section=new i),d(s.node.section,n,a)}else s.node.attributes.push(c.makeLiveBindingBranchRenderer(null,a,u()));else d(r,n,a)},comment:function(e){r.add({comment:e})},done:function(){}}),r.compile()}t=t||e.view.parser,o=o||e.view.callbacks;var u="http://www.w3.org/2000/svg",l={svg:u,g:u},p={"\n":"\\n","\r":"\\r","\u2028":"\\u2028","\u2029":"\\u2029"},f=function(e){return(""+e).replace(/["'\\\n\r\u2028\u2029]/g,function(e){return"'\"\\".indexOf(e)>=0?"\\"+e:p[e]})};return e.view.register({suffix:"stache",contentType:"x-stache-template",fragRenderer:function(e,t){return d(t)},script:function(e,t){return'can.stache("'+f(t)+'")'}}),e.view.ext=".stache",e.extend(e.stache,r),e.extend(d,r),e.stache.safeString=d.safeString=function(e){return{toString:function(){return e}}},e.stache.async=function(t){var n=s(t),a=e.map(n.imports,function(t){return e["import"](t)});return e.when.apply(e,a).then(function(){return d(n.intermediate)})},d});
/*[global-shim-end]*/
